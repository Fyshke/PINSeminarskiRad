intellisense.annotate(jQuery, {
  ...
  'get': function() {
    ...
    ///   <param name="dataType" type="String">The type of data expected from the server. Default: Intelligent pokusaj (xml, json, script, or html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'getJSON': function() {
  ...
  'post': function() {
    ...
    ///   <param name="dataType" type="String">The type of data expected from the server. Default: Intelligent pokusaj (xml, json, script, text, html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'proxy': function() {
